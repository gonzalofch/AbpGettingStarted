...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 9b94c5a5-31cb-4044-94ab-3a7dcb89f05e
```

> `9b94c5a5-31cb-4044-94ab-3a7dcb89f05e` is the password of the certificate, you can change it to any password you want.
